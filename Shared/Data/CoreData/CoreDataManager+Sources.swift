...
extension CoreDataManager {
    ...
    private func createNewSourceEntity(from sourceData: SourcesData, url: String, iconURL: URL?, context: NSManagedObjectContext) -> Source {
    ...
    private func createNewSourceEntity(name: String, id: String, url: String, iconURL: URL?, context: NSManagedObjectContext) -> Source {
        let newSource = Source(context: context)
        newSource.name = name
