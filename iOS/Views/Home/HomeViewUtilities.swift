...
class HomeViewUtilities {
    ...
    func presentAlert(in viewController: HomeViewController, title: String, message: String, buttonTitle: String = "OK", handler: ((UIAlertAction) -> Void)? = nil) {
    ...
    func showInputAlert(in viewController: HomeViewController, title: String, message: String, actionTitle: String, initialText: String = "", completion: @escaping (String) -> Void) {
    ...
    func handleError(in viewController: HomeViewController, error: Error, withTitle title: String = "Error") {
